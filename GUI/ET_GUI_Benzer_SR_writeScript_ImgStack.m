...
[~,fileBasis] = fileparts(fileparts(movFileName)); 
% get file basis name
...
if goOn==1,
    ...
    if prevDetection ==1,
        ...
        fprintf(fid,'%s\n','traceResult(1,:) = ET_anaS_basic4BenzerFrame(fPos,IDX,1,...');
        ...
        fprintf(fid,'%s\n','         traceResult(frameNumber,:) = ET_anaS_basic4BenzerFrame(fPos,IDX,frameNumber,...');
        fprintf(fid,'%s\n','                  angleCorrection,backGround,bgSubModus,contrastThresh,eroderR,...');
