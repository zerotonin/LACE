...
if ~isempty(saccs),
    ...
    trigAveL = triggeredAverage([rad2deg(trace(:,3)),trace(:,6)],saccs(saccs(:,4) == 1,2),ceilfps/4,[],10);
    trigAveR = triggeredAverage([rad2deg(trace(:,3)),trace(:,6)],saccs(saccs(:,4) == -1,2),ceilfps/4,[],10);
