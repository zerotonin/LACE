function [backGround,backGroundMax,backGroundMin] = ET_bg_calcForNorPixSeq...
    (fid,headerInfo,endianType,IDX,modus,progBar,headSize)
...
% read first image
backGround = ivT_norpix_loadSingleImage(fid,headerInfo,endianType,IDX,1,headSize);
...
switch headerInfo.ImageBitDepth,
    case 8
