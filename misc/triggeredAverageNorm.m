function trigAve = triggeredAverageNorm(data,trigInd,winSize,indices,set2zero)
...
%
% This function also normalises each window to the feature value of the
% occurence
%
% GETS:
...
for j =1:numFeatures,
    ...
    % normalise to event
    peaks = temp(:,winSize+1);
    temp = bsxfun(@rdivide,temp,peaks);
