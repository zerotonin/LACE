function [h1,h2] = errorareaTrans2(xValues,yValues,errH,errL,lineColor, areaColor,alpha)
...
h2 = fill(x,y,areaColor,'LineStyle','none','facealpha',alpha); hold on;
h1 = plot(xValues,yValues,'color',lineColor);hold off;
