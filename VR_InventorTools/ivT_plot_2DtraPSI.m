function ivT_plot_2DtraPSI(anaTRA,fps,lolliN,cBFlag,tailLength,psiIndex,cmap)
...
for z = lollipopIndex,
    ...
    plot([anaTRA(z,1) x_orient(1)],[anaTRA(z,2) x_orient(2)],'Color',cmap(psiIndex(z),:))
    plot(anaTRA(z,1),anaTRA(z,2),'o','Color',cmap(psiIndex(z),:),'MarkerFaceColor',cmap(psiIndex(z),:))
